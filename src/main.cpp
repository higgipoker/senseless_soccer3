...
//  Engine::Window window2(game.window_title, game.window_rect.width,
...
//    BallShadowSPrite.setOrigin(BALL_SPRITE_WIDTH / 2, BALL_SPRITE_HEIGHT / 2);
...
//    BallShadowSPrite.setTextureRect(ball_frames[7]);
