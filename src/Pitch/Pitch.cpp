...
Vector3 Pitch::toPitchSpace(const Vector3& in_vector) const {
    ...
    return {in_vector.x - draw_dimensions.origin.x, origin + height - in_vector.y};
}
//
//
//
...
void Pitch::init_center_circle() {
    ...
    draw_dimensions.center_circle.setRadius(Metrics::MetersToPixels(9.15f));
...
void Pitch::init_center_spot() {
    draw_dimensions.center_spot.setRadius(Metrics::MetersToPixels(0.2f));
...
void Pitch::init_penalty_spots() {
    draw_dimensions.south_penalty_spot.setRadius(Metrics::MetersToPixels(0.2f));
...
void Pitch::init_south_arc() {
    ...
    draw_dimensions.south_arc.setRadius(Metrics::MetersToPixels(7.f));
