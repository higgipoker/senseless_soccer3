...
void Locomotion::stay_in_pitch() {
  ...
  if (player.movable.position.x >
      pitchrect.getPosition().x + pitchrect.getSize().x - buffer) {
    player.movable.position.x =
        pitchrect.getPosition().x + pitchrect.getSize().x - buffer;
    player.movable.velocity.x = -player.movable.velocity.x;
  }
  ...
  if (player.movable.position.y >
      pitchrect.getPosition().y + pitchrect.getSize().y - buffer) {
