...
//
//
void PlayingPosition::clamp(Engine::Vector3 &in_v1, Engine::Vector3 &in_v2, Engine::Vector3 &in_v3,
                            Engine::Vector3 &in_v4) {
...
//
//
PlayingPosition::PlayingPosition(const Pitch &in_pitch, const Team &in_my_team, const Team &in_other_team)
...
//
//
Engine::Vector3 PlayingPosition::getSetPiecePosition(const Situation in_situation, const Direction in_pitch_side) {
