...
///
struct RenderLayer {
    RenderLayer(bool in_sortable = false, bool in_overlay = false) : sortable(in_sortable), overlay(in_overlay) {
    }
    bool                    sortable = false;
    bool                    overlay = false;
...
class GameEngine {
   public:
                                ...
                                ~GameEngine         ();
        void                    step                () noexcept;
        int                     addLayer            (const bool in_sortable = false, const bool in_overlay = false) noexcept;
