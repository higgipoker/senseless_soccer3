...
//
//
SpriteAnimation::SpriteAnimation(const int in_id, const int in_speed, const std::vector<int>& in_frames, bool in_loop)
    : id(in_id),
...
//
//
SpriteAnimation::SpriteAnimation(const int in_id, std::initializer_list<int> in_args) : id(in_id) {
...
//
//
void SpriteAnimation::setLoopable(bool in_yesorno) {
    loop = in_yesorno;
}
//
//
